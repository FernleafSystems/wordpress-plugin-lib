...
class Users extends Base {
	...
	public function getUserByUsername( $sUsername ) {
		...
		if ( version_compare( Services::WpGeneral()->getWordpressVersion(), '2.8.0', '<' ) ) {
	...
	public function getUserById( $nId ) {
		if ( version_compare( Services::WpGeneral()->getWordpressVersion(), '2.8.0', '<' ) || !function_exists( 'get_user_by' ) ) {
			return null;
		}
